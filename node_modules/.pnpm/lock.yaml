...
devDependencies:
  ...
  ts-node-dev:
    specifier: ^2.0.0
    version: 2.0.0(@types/node@20.11.25)(typescript@5.4.2)
...
packages:
  ...
  /@types/koa2-cors@2.0.5:
    resolution: {integrity: sha512-MrZ8NpnkPYQqTRy2Llflt2f2sLTQTSy5fAOa2YTxUu6UJZXdsY6cszpzuB9EhkAFXJL1D8kEEHGq4Q7rU+jEAg==}
    dependencies:
      '@types/koa': 2.15.0
    dev: true
  ...
  /ts-node-dev@2.0.0(@types/node@20.11.25)(typescript@5.4.2):
